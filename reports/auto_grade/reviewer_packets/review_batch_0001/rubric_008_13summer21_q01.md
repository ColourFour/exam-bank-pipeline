...
- Question image: [p1/13summer21/questions/q01.png](p1/13summer21/questions/q01.png)
- Mark-scheme image: [p1/13summer21/mark_scheme/q01.png](p1/13summer21/mark_scheme/q01.png)
...
```text
1 f(x)= 2x^{3} + 8x [ +c] B1 Allow any correct form
```

### Event 2: `13summer21_q01_me0002`
...
```text
f(x) = 2x^{3} + 8x−13 A1 Allow answery = , f(x) or y can appear earlier in
```
...
```json
{
  ...
  "events": [
    {
      "accepted_evidence": [],
      "advisory_evidence": {
        "answer_text": "\uf8ee\uf8f0f(x)=\uf8f9\uf8fb 2x^{3} + 8x [ +c]",
        "common_error_text": "",
        "condition_text": "",
        "confidence": "high",
        "normalized_text": "1 \uf8ee\uf8f0f(x)=\uf8f9\uf8fb 2x^{3} + 8x [ +c] B1 Allow any correct form",
        "raw_text": "1 \uf8ee\uf8f0f(x)=\uf8f9\uf8fb 2x^{3} + 8x [ +c] B1 Allow any correct form"
      },
      "alternative_methods": [],
      "common_errors": [],
      "dependency": "independent",
      "event_id": "rr_13summer21_q01_e0001",
      "follow_through_policy": "none",
      "learning_target_ids": [],
      "mark_code": "B",
      "mark_type": "independent_statement",
      ...
      "source_event_id": "13summer21_q01_me0001"
    },
    {
      "accepted_evidence": [],
      "advisory_evidence": {
        ...
        "condition_text": "",
        "confidence": "high",
        "normalized_text": "7 = 16 + 4 + c M1 Substitute f(2) = 7 into an integral.",
        "raw_text": "7 = 16 + 4 + c M1 Substitute f(2) = 7 into an integral."
      },
      "alternative_methods": [],
      "common_errors": [],
      "dependency": "independent",
      "event_id": "rr_13summer21_q01_e0002",
      "follow_through_policy": "none",
      "learning_target_ids": [],
      "mark_code": "M",
      "mark_type": "method",
      ...
      "review_notes": "",
      "review_status": "needs_human_review",
      "source_event_id": "13summer21_q01_me0002"
    },
    {
      "accepted_evidence": [],
      "advisory_evidence": {
        "answer_text": "f(x) = 2x^{3} + 8x\u221213",
        "common_error_text": "",
        "condition_text": "",
        "confidence": "high",
        "normalized_text": "f(x) = 2x^{3} + 8x\u221213 A1 Allow answery = , f(x) or y can appear earlier in",
        "raw_text": "f(x) = 2x^{3} + 8x\u221213 A1 Allow answery = , f(x) or y can appear earlier in"
      },
      "alternative_methods": [],
      "common_errors": [],
      "dependency": "independent",
      "event_id": "rr_13summer21_q01_e0003",
      "follow_through_policy": "none",
      "learning_target_ids": [],
      "mark_code": "A",
      "mark_type": "accuracy",
      ...
      "review_notes": "",
      "review_status": "needs_human_review",
      "source_event_id": "13summer21_q01_me0003"
    }
  ],
  "paper": "13summer21",
  "paper_family": "p1",
  ...
  "reviewed_at": null,
  "reviewed_by": null,
  "rubric_id": "rr_13summer21_q01",
  "rubric_total_verified": false,
  "safe_for_auto_grade_lab": false,
  "safe_for_student_self_check": false,
  "safe_for_teacher_beta": false,
  "source_mark_events_record_id": "13summer21_q01",
  "source_mark_scheme_image_path": "p1/13summer21/mark_scheme/q01.png",
  "source_question_id": "13summer21_q01",
  "total_marks": 3
}
```
