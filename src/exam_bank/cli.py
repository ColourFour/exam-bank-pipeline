...
def build_parser() -> argparse.ArgumentParser:
    ...
    process.add_argument(
        "--allow-empty",
        action="store_true",
        help="Explicitly allow a successful empty question bank when no question-paper PDFs are classified.",
    )
...
def cmd_process(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if bool(getattr(args, "allow_empty", False)):
            process_kwargs["allow_empty"] = True
