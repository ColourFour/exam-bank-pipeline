...
def _record_to_output_dict(record: QuestionRecord, output_root: Path | None) -> dict[str, Any]:
    ...
    return {
        ...
        "mark_scheme_block_ids": mark_scheme.block_ids,
        "mark_scheme_confidence_score": round(float(mark_scheme.confidence_score or 0.0), 3),
        ...
        "notes": {
            ...
            "missing_mark_scheme_reason": mark_scheme.missing_mark_scheme_reason,
