...
| 2 | `32winter21_q04` | `32winter21` | P3 / November 2021, component 32 | 4 | native | Same as selected | `4 Express 4x? — 13x + 13 (2x — 1)(x - 3) in partial fractions. [5]` | `4 Express (42xx^{2} - -(13x 13)/(1 x 3))( + - ) in partial fractions. [5]` | Flattened fraction changes algebraic meaning; OCR/native disagreement. | PNG paths remain `p3/32winter21/questions/q04.png` and `p3/32winter21/mark_scheme/q04.png`. | rational-expression-math |
| 3 | `33winter21_q04` | `33winter21` | P3 / November 2021, component 33 | 4 | native | Same as selected | `Te 4 Find the exact value of \| xsin 4x dx. 1 3"` | `4 Find the exact value of ∫_{1}_{3}^{π}_{π} x sin^{ 1}_{2}x dx. [5]` | Integral bounds/function flattened; OCR/native disagreement. | PNG paths remain `p3/33winter21/questions/q04.png` and `p3/33winter21/mark_scheme/q04.png`. | integral-layout |
| 4 | `33winter21_q05` | `33winter21` | P3 / November 2021, component 33 | 5 | native | Same as selected | `5 Solve the equation sin 0 = 3 cos 26 + 2, for 0° < @ < 360°. [5]` | `5 Solve the equation sin θ = 3 cos 21 + 2, for 0° ≤ θ ≤ 360°. [5]` | Trig argument corrupted (`2θ` appears as `21`). | PNG paths remain `p3/33winter21/questions/q05.png` and `p3/33winter21/mark_scheme/q05.png`. | trig-symbol-fidelity |
...
| 11 | `33winter25_q07` | `33winter25` | P3 / November 2025, component 33 | 7 | native | Same as selected | `7 Solve the equation 33 722 *+20+8i = 0... [6]` | `7 Solve the equation (5z)/(2 - i) - zz^{*} + 20 + 8i = 0... where x and y are` | Missing mark bracket and apparent truncation. | PNG paths remain `p3/33winter25/questions/q07.png` and `p3/33winter25/mark_scheme/q07.png`. | truncated-math-prompt |
| 12 | `13winter25_q09` | `13winter25` | P1 / November 2025, component 13 | 9 | native | Same as selected | `...curve with equation y = 5x+4 and the line y = 4.5... [8]` | `9 The diagram shows part of the curve with equation y = 12x + 4x and the line y = 4 5...` | Diagram/math flattening; missing mark bracket; likely truncation. | PNG paths remain `p1/13winter25/questions/q09.png` and `p1/13winter25/mark_scheme/q09.png`. | volume-diagram-text |
| 13 | `43winter21_q06` | `43winter21` | P4 / November 2021, component 43 | 6 | OCR | Not separately persisted; native_score=129 | `The diagram shows a particle of mass 5 kg...` | Same as OCR | Missing leading question number in selected text. | PNG paths remain `p4/43winter21/questions/q06.png` and `p4/43winter21/mark_scheme/q06.png`. | question-anchor-presence |
...
| 23 | `11winter23_q04` | `11winter23` | P1 / November 2023, component 11 | 4 | native | Same as selected | `(b) (c) The transformation R denotes...` | `4 The transformation R denotes a reflection in the@ A x-axis...` | Degraded clean crop; transformation vector/furniture inserted into prose. | PNG paths remain `p1/11winter23/questions/q04.png` and `p1/11winter23/mark_scheme/q04.png`. | transformation-vector-layout |
| 24 | `12winter23_q06` | `12winter23` | P1 / November 2023, component 12 | 6 | native | Same as selected | `6 The equation of a curve is y = x -— 8x45...` | `6 The equation of a curve is y = x^{2}-8x + 5... translated by@ 41A...` | Degraded clean crop; translation vector flattened into garbage. | PNG paths remain `p1/12winter23/questions/q06.png` and `p1/12winter23/mark_scheme/q06.png`. | transformation-vector-layout |
| 25 | `51winter23_q05` | `51winter23` | P5 / November 2023, component 51 | 5 | native | Same as selected | `5 A red spinner has four sides labelled...` | `5 Aredspinnerhasfoursideslabelled1,2,3,4...` | Degraded text despite high crop; table/prose spacing collapsed. | PNG paths remain `p5/51winter23/questions/q05.png` and `p5/51winter23/mark_scheme/q05.png`. | clean-crop-spacing |
| 26 | `42winter21_q01` | `42winter21` | P4 / November 2021, component 42 | 1 | native | Same as selected | `...velocity-time graph which models the motion of a car...` | `1 Thesixstraightdiagramlineshowssegments.avelocity-time... 20 m sacar._{-}The_{1}...` | Diagram/furniture dominance; prose and axis labels interleaved. | PNG paths remain `p4/42winter21/questions/q01.png` and `p4/42winter21/mark_scheme/q01.png`. | mechanics-graph-reading-order |
| 27 | `52winter21_q01` | `52winter21` | P5 / November 2021, component 52 | 1 | native | Same as selected | `(b) (c) Each of the 180 students...` | `1 Eachofthe180studentsatacollegeplaysexactlyoneofthepiano...` | Table/prose merge; raw OCR shows subpart labels before stem. | PNG paths remain `p5/52winter21/questions/q01.png` and `p5/52winter21/mark_scheme/q01.png`. | table-reading-order |
...
| 30 | `33winter21_q02` | `33winter21` | P3 / November 2021, component 33 | 2 | native | Same as selected | `2 (a) Sketch the graph of y = \|2x — 3}. (b) Solve the inequality... [3] [1]` | `2 (a) Sketch the graph of y = \|2x -3\|. [1] (b) Solve the in equal it y... [3]` | OCR/native disagreement; mark order differs; word split. | PNG paths remain `p3/33winter21/questions/q02.png` and `p3/33winter21/mark_scheme/q02.png`. | subpart-mark-order |
