...
| 32winter21_q04 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | short_single_part_question, visual_crop_scope_from_text_only |
| 33winter21_q04 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | math_expression_semantics, visual_crop_scope_from_text_only |
| 33winter21_q05 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | math_expression_semantics, short_single_part_question, visual_crop_scope_from_text_only |
...
| 33winter25_q07 | low_crop_confidence, missing_mark_bracket, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
| 13winter25_q09 | low_crop_confidence, missing_mark_bracket, selector_structural_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
| 43winter21_q06 | missing_expected_question_number, selected_ocr_with_structural_warnings, selector_structural_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
...
| 11winter23_q04 | clean_visual_crop_but_degraded_text, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | math_expression_semantics, visual_crop_scope_from_text_only |
| 12winter23_q06 | clean_visual_crop_but_degraded_text, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | math_expression_semantics, visual_crop_scope_from_text_only |
| 51winter23_q05 | clean_visual_crop_but_degraded_text, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
| 42winter21_q01 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
| 52winter21_q01 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | visual_crop_scope_from_text_only |
...
| 33winter21_q02 | low_crop_confidence, selector_structural_warning_present, selector_warning_present | missing_crop_pixel_dimensions, missing_raw_candidate_windows | math_expression_semantics, visual_crop_scope_from_text_only |
