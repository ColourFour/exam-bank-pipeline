...
- [ ] Detect crops that include neighboring questions, page headers only, blank regions, weak anchors, or multi-question spans.
...
- [ ] Generate small review packs for suspicious output samples, including the relevant question image, mark-scheme image, record metadata, and reason flags.
